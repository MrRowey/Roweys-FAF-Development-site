...
<div class="w3-container" style="padding:80px 16px" id="about">
  <h3 class="w3-center">DataHub</h3>
  <p class="w3-center w3-large">Link page to specific datasets</p>
  <div class="w3-row-padding w3-center" style="margin-top:64px">
    <div class="w3-third">
      <i class="fa fa-microchip w3-margin-bottom w3-jumbo w3-center"></i>
      <p class="w3-xlarge">1v1 Data</p>
      <p>This is all the Match Data from all the torunamets collected by X in a visual represtaion.</p>
      <a class="w3-btn w3-round w3-border" type="submit" href="/public/1v1data.html">Link to 1v1 Data</a>
    </div>
    <div class="w3-third">
      <i class="fa fa-user w3-margin-bottom w3-jumbo"></i>
      <p class="w3-xlarge">Player Data</p>
      <p>This is all the Tournament Data that is Relevent to X Player from each tournament.</p>
      <a class="w3-btn w3-round w3-border" type="submit" href="/public/playerdata.html">Link to Player Data</a>
    </div>
    <div class="w3-third">
      <i class="fa fa-diamond w3-margin-bottom w3-jumbo"></i>
      <p class="w3-xlarge">Tournament Data</p>
      <p>This is overall data from all of the the tournament themself.</p>
      <a class="w3-btn w3-round w3-border" type="submit" href="/public/tournamentdata.html">Link to Tournament Data</a>
    </div>
  </div>
</div>
<script>
