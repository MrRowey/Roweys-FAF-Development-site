<?php 
    ...
    // Proceing the data from the form
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(empty(trim($_POST["username"]))){
            ...
            if($stmt = mysqli_prepare($link, $sql)){
                // bingin the varable to the prepared stamenbt at parametesr
                mysqli_stmt_bind_param($stmt, "s", $param_username);

                // setting the paramater
                $param_username = trim($_POST["username"]);

                // executing the parapeter
                if(mysqli_stmt_execute($stmt)){
                    ...
                    echo "Opps! Something went wrong. pelase trya agin later.";
                    }
...
<main>    
    <div class="wrapper">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            ...
            <input type="reset" class="btn btn-seconday" value="Reset"><br>
