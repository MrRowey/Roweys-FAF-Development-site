...
<html>
  <head>
    <title>Roweys FAF Dev Site</title>
    <meta charset="UTF-8">
    ...
    .bgimg-1 {
      ...
      background-image: url('/styles/images/home.jpg');
      min-height: 100%;
    }
...
<header class="bgimg-1 w3-display-container" id="home">
  <div class="w3-display-left w3-text-white" style="padding:48px">
    <span class="w3-jumbo w3-hide-small"> Rowey FAF Systems</span><br>
    <span class="w3-xxlarge w3-hide-large w3-hide-medium">Rowey FAF Systems</span><br>
    <span class="w3-large"> All System that are apart of this site were created by Rowey</span>
    <p><a href="/about.html" class="w3-button w3-light-gray w3-padding-large w3-large w3-margin-top w3-round ">Find out more about this site</a></p>
  </div> 
</header>
<script>
