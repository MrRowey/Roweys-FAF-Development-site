...
<div class="w3-container w3-light-grey" style="padding:90px 16px" id="contact">
  ...
  <p class="w3-center w3-large">Below are the best way get in touch. Send us a message:</p>
  <div class="w3-center" style="margin-top:48px">
    ...
    <p><i class="fa fa-envelope fa-fw w3-xxlarge w3-margin-right"></i><a href="mailto:Rowey.lab@gmail.com">Rowey.lab@gmail.com</a></p>
